...
<body>
  ...
  <div class="section">
    <ul>
      <li><strong>Linguagens:</strong> HTML, CSS, JavaScript (pode adicionar mais conforme seu conhecimento)</li>
      <li><strong>Ferramentas:</strong> Git, Visual Studio Code, Figma (edite conforme necessário)</li>
